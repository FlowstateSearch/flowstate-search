      ...
      <div className="container py-12 md:py-16">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-lg md:text-xl text-foreground/90 leading-relaxed mb-8 font-light">
            You knew six months in. Maybe sooner. But you kept waiting for it to turn around, because admitting it felt worse than living with it. That decision cost you more than you think.
          </p>
          ...
          {/* H2: Hidden Costs */}
          <h2 className="text-2xl font-heading font-bold text-foreground mb-4">The Hidden Costs That Do Not Show Up on a Spreadsheet</h2>
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
          ...
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
            The first is a skills mismatch that was not caught in the interview process. The candidate interviewed well, had the right titles on their resume, and said the right things. But nobody actually tested whether they could do the job in your specific context. Your project types, your subcontractor relationships, your risk profile.
          </p>
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
            The second is a fit mismatch that nobody wanted to address. The candidate was technically qualified but did not work the way your company actually operates. Maybe they came from a top-down firm and you run a collaborative shop. Maybe they were used to a support structure you do not have. Either way, it was visible early and nobody said the hard thing.
          </p>
          <p className="text-base text-muted-foreground leading-relaxed mb-12">
            The third, and most common, is that the hire came from a pool of active candidates. People who are actively looking for jobs are, by definition, available. The best construction executives are rarely available. They are employed, performing well, and not checking job boards. When you hire from the active pool, you are choosing from the people who are looking. Not the people who are winning.
          </p>
          ...
          <p className="text-base text-muted-foreground leading-relaxed mb-4">
            Flowstate Search's <Link href="/why-flowstate"><span className="text-primary hover:underline cursor-pointer">retention rate at 24 months is 91 percent</span></Link>. The difference is not luck. It is the result of a process built specifically to avoid the three failure modes above: rigorous skills assessment, deep culture alignment work, and a candidate pool built from passive talent that is not available anywhere else.
          </p>
          <p className="text-base text-muted-foreground leading-relaxed mb-12">
          ...
          <div className="bg-foreground text-background rounded-2xl p-8 md:p-10">
            ...
            <p className="text-sm text-background/70 mb-6 leading-relaxed">
              If you want to understand <Link href="/how-we-work"><span className="text-primary hover:underline cursor-pointer">how we work</span></Link> before you commit to anything, start there. Or if you are ready to move:
            </p>
            ...
            <p className="text-xs text-background/50 mt-4">No pitch. No pressure. Just a straight answer about whether we are the right fit.</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-2xl">
            <Link href="/blog/how-to-find-passive-construction-candidates">
              <div className="group cursor-pointer">
                ...
                <p className="text-sm font-semibold text-foreground group-hover:text-primary transition-colors leading-snug">How to Find Passive Construction Candidates (Who Are Not on Job Boards)</p>
              </div>
            </Link>
